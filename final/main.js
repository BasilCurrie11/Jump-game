//map
  ...
  a7.addEventListener('click',function(){
    map.jumpTo({center: [-76.17797, 45.242],zoom: 15});
    console.log('a6');
  })
  ...
  map.on('load', () => {
      ...
      (error, image) => {
        ...
        map.addSource('route', {
            ...
            'data': 
            {
              ...
              "properties": {
                "PlaceName": "Route To Work",
                "Location": "March Road",
                "Built": "Unknown",
                "Description": "My route to work.",
                 "Image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWxP_ki-tytMT9J7ync36DXbeVRAgnweE-hQ&s"
              }
          },
        });
        map.addLayer({
    ...
    map.on('mouseout', 'route', () => {
      map.getCanvas().style.cursor = "crosshair";
  });


//Adds historic buildings to the map
            ...
            "features": [
              {
                ...
                "geometry": {
                  "type": "Point",
                  "coordinates": [-76.183, 45.2348]
                },
                "properties": {
                  "PlaceName": "Patrice's YIG",
                  "Location": "401 Ottawa Street",
                  "Built": "Unknown",
                  "Description": "The grocery store where I used to work.",
                  "Image": "https://bloximages.chicago2.vip.townnews.com/insideottawavalley.com/content/tncms/assets/v3/editorial/c/75/c7537d88-5b0a-52e7-993c-b5adb6d044e6/63d817e85d10c.image.jpg?resize=1200%2C900"
                }
              },
              {
                "type": "Feature",
